...
[दस्तावेज़ पढ़ें →](https://lingo.dev/compiler) पूरी गाइड के लिए, और [हमारे Discord में शामिल हों](https://lingo.dev/go/discord) अपने सेटअप में मदद पाने के लिए।
...
| **CLI**     | वेब और मोबाइल ऐप्स, JSON, YAML, markdown, + अधिक के लिए वन-कमांड स्थानीयकरण | [/cli](https://lingo.dev/cli)           |
...
यह प्रत्येक स्ट्रिंग को फिंगरप्रिंट करता है, परिणामों को कैश करता है, और केवल बदली हुई चीज़ों का पुनः अनुवाद करता है।

इसे सेट अप करने का तरीका जानने के लिए [दस्तावेज़ देखें →](https://lingo.dev/cli)।

---

### 🔄 Lingo.dev CI/CD

स्वचालित रूप से परफेक्ट अनुवाद डिलीवर करें।
...
आपके रेपो को ग्रीन रखता है और आपके प्रोडक्ट को मैनुअल स्टेप्स के बिना बहुभाषी बनाता है।
...
हम कम्युनिटी-ड्रिवन हैं और योगदान को पसंद करते हैं!

- कोई आइडिया है? [इश्यू ओपन करें](https://github.com/lingodotdev/lingo.dev/issues)
- कुछ ठीक करना चाहते हैं? [PR भेजें](https://github.com/lingodotdev/lingo.dev/pulls)
- मदद चाहिए? [हमारे Discord से जुड़ें](https://lingo.dev/go/discord)

## ⭐ स्टार हिस्ट्री

यदि आपको हमारा काम पसंद है, तो हमें एक ⭐ दें और 10,000 स्टार तक पहुँचने में हमारी मदद करें! 🌟
...
**लोकेल प्रारूप:** [BCP-47](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Locale) कोड का उपयोग करें: `language[-Script][-REGION]`
