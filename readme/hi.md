...
| [**Compiler**](#lingodev-compiler) | i18n रैपर्स के बिना बिल्ड-टाइम React लोकलाइज़ेशन     | `withLingo()` प्लगइन               |
...
2. अनुवाद के लिए LLM प्रोवाइडर को कंटेंट भेजता है
...
`provider` फ़ील्ड वैकल्पिक है (डिफ़ॉल्ट Lingo.dev Engine है)। कस्टम LLM प्रोवाइडर्स के लिए:
...
पारंपरिक i18n आक्रामक है। आप हर स्ट्रिंग को `t()` फ़ंक्शन में लपेटते हैं, अनुवाद कुंजियाँ (`home.hero.title.v2`) बनाते हैं, समानांतर JSON फ़ाइलें बनाए रखते हैं, और अपने कंपोनेंट्स को लोकलाइज़ेशन बॉयलरप्लेट से फूलते हुए देखते हैं। यह इतना थकाऊ है कि टीमें अंतर्राष्ट्रीयकरण को तब तक टालती हैं जब तक कि यह एक बड़ा रिफ़ैक्टर न बन जाए।
...
- शून्य रनटाइम परफ़ॉर्मेंस लागत
- कोई अनुवाद कुंजियाँ या JSON फ़ाइलें नहीं
- कोई `t()` फ़ंक्शन या `<T>` रैपर कंपोनेंट्स नहीं
...
- `cache-only`: CI से पूर्व-जेनरेट किए गए अनुवादों का उपयोग करके प्रोडक्शन मोड (कोई API कॉल नहीं)
