...
**Produzione:** Impostare `usePseudotranslator: false`, quindi `next build`

Committare la directory `.lingo/` nel version control.
...
2. **Pull request:** [invia modifiche](https://github.com/lingodotdev/lingo.dev/pulls)
   ...
   - Assicurarsi che i test passino prima di inviare
3. **Sviluppo:** questo è un monorepo pnpm + turborepo
   - Installare le dipendenze: `pnpm install`
...
1. Aggiungere il codice locale a [`i18n.json`](./i18n.json) utilizzando il [formato BCP-47](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Locale)
2. Inviare una pull request
