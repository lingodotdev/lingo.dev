...
| [**Compiler**](#lingodev-compiler) | i18n ৰেপাৰ নোহোৱাকৈ বিল্ড-টাইম React স্থানীয়কৰণ | `withLingo()` প্লাগইন              |
...
4. প্ৰয়োজনীয় কনফিগাৰেচন ফাইল জেনেৰেট কৰক
...
1. কনফিগাৰ কৰা ফাইলৰ পৰা অনুবাদযোগ্য সমল এক্সট্ৰেক্ট কৰে
...
`init` আদেশে এটা `i18n.json` ফাইল জেনেৰেট কৰে। লোকেল আৰু বাকেট কনফিগাৰ কৰক:
...
`provider` ফিল্ড ঐচ্ছিক (ডিফল্ট Lingo.dev Engine)। কাষ্টম LLM প্ৰদানকাৰীৰ বাবে:
...
| `pull-request`       | `false`                                        | পোনপটীয়াকৈ কমিট কৰাৰ সলনি PR সৃষ্টি কৰক |
...
2. **পুল ৰিকুৱেষ্ট:** [পৰিৱৰ্তন জমা দিয়ক](https://github.com/lingodotdev/lingo.dev/pulls)
   - প্ৰতিটো PR-ৰ বাবে এটা changeset প্ৰয়োজন: `pnpm new` (বা নন-ৰিলিজ পৰিৱৰ্তনৰ বাবে `pnpm new:empty`)
