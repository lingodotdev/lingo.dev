...
| টুল          | TL;DR                                                                         | দস্তাবেজ                                |
| ------------ | ----------------------------------------------------------------------------- | --------------------------------------- |
| **Compiler** | বিল্ড-সময় React স্থানীয়কৰণ                                                  | [/compiler](https://lingo.dev/compiler) |
| **CLI**      | ৱেব আৰু মোবাইল এপ, JSON, YAML, markdown, + অধিকৰ বাবে এক-আদেশ স্থানীয়কৰণ     | [/cli](https://lingo.dev/cli)           |
| **CI/CD**    | প্ৰতিটো পুছত স্বয়ংক্ৰিয়-কমিট অনুবাদ + প্ৰয়োজন হ'লে pull request সৃষ্টি কৰক | [/ci](https://lingo.dev/ci)             |
| **SDK**      | ব্যৱহাৰকাৰী-সৃষ্ট সমলৰ বাবে ৰিয়েলটাইম অনুবাদ                                 | [/sdk](https://lingo.dev/sdk)           |
...
[দস্তাবেজ অনুসৰণ কৰক →](https://lingo.dev/cli) ইয়াক কেনেকৈ ছেটআপ কৰিব লাগে জানিবলৈ।

---

### 🔄 Lingo.dev CI/CD

স্বয়ংক্ৰিয়ভাৱে নিখুঁত অনুবাদ প্ৰদান কৰক।
...
আপোনাৰ ৰিপ' সেউজীয়া আৰু আপোনাৰ প্ৰডাক্ট বহুভাষিক ৰাখে হস্তচালিত পদক্ষেপ অবিহনে।
...
গতিশীল সমলৰ বাবে তাৎক্ষণিক প্ৰতি-অনুৰোধ অনুবাদ।
...
- কিবা ধাৰণা আছে? [এটা ইছ্যু খোলক](https://github.com/lingodotdev/lingo.dev/issues)
...
যদি আপনি আমাৰ কামটো ভাল পায়, আমাক এটা ⭐ দিয়ক আৰু আমাক 10,000 তৰা লাভ কৰাত সহায় কৰক! 🌟
...
**Locale ফৰ্মেট:** [BCP-47](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Locale) ক'ড ব্যৱহাৰ কৰক: `language[-Script][-REGION]`
