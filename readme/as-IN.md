...
- `cache-only`: CI ৰ পৰা পূৰ্ব-সৃষ্টি কৰা অনুবাদ ব্যৱহাৰ কৰি প্ৰডাকচন ম'ড (কোনো API কল নাই)
...
1. **সমস্যাসমূহ:** [বাগ ৰিপ'ৰ্ট কৰক বা বৈশিষ্ট্য অনুৰোধ কৰক](https://github.com/lingodotdev/lingo.dev/issues)
