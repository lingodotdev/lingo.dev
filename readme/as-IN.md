...
- JSX-ত অনুবাদযোগ্য পাঠৰ স্বয়ংক্ৰিয় চিনাক্তকৰণ
- TypeScript সমৰ্থন
...
- `real`: LLM ব্যৱহাৰ কৰি প্ৰকৃত অনুবাদ সৃষ্টি কৰক
- `cache-only`: CI ৰ পৰা পূৰ্ব-সৃষ্ট অনুবাদ ব্যৱহাৰ কৰি প্ৰডাকচন ম'ড (কোনো API কল নাই)
