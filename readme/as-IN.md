...
| সঁজুলি                             | ব্যৱহাৰৰ ক্ষেত্ৰ                               | দ্ৰুত আদেশ                         |
| ---------------------------------- | ---------------------------------------------- | ---------------------------------- |
| [**MCP**](#lingodev-mcp)           | React এপৰ বাবে AI-সহায়ক i18n ছেটআপ            | প্ৰমপ্ট: `Set up i18n`             |
...
| [**SDK**](#lingodev-sdk)           | গতিশীল সমল বাবে ৰানটাইম অনুবাদ                 | `npm install lingo.dev`            |
| [**Compiler**](#lingodev-compiler) | i18n ৰেপাৰ অবিহনে বিল্ড-টাইম React স্থানীয়কৰণ | `withLingo()` প্লাগইন              |
...
3. স্বয়ংক্ৰিয় লোকেল চিনাক্তকৰণ ৰূপায়ণ কৰক
4. প্ৰয়োজনীয় কনফিগাৰেশ্বন ফাইল সৃষ্টি কৰক
...
1. কনফিগাৰ কৰা ফাইলৰ পৰা অনুবাদযোগ্য সমল উলিয়াই আনে
2. অনুবাদৰ বাবে LLM প্ৰদানকাৰীলৈ সমল প্ৰেৰণ কৰে
3. অনুবাদিত সমল ফাইলছিষ্টেমলৈ লিখে
4. সম্পূৰ্ণ হোৱা অনুবাদ ট্ৰেক কৰিবলৈ `i18n.lock` ফাইল সৃষ্টি কৰে (অপ্ৰয়োজনীয় প্ৰক্ৰিয়াকৰণ এৰাই চলে)

**কনফিগাৰেশ্যন:**

`init` আদেশে এটা `i18n.json` ফাইল সৃষ্টি কৰে। লোকেল আৰু বাকেট কনফিগাৰ কৰক:
...
`provider` ক্ষেত্ৰ ঐচ্ছিক (ডিফল্ট Lingo.dev Engine)। কাষ্টম LLM প্ৰদানকাৰীৰ বাবে:
...
| `parallel`           | `false`                                        | সমান্তৰাল প্ৰক্ৰিয়াকৰণ সক্ষম কৰক            |
...
পৰম্পৰাগত i18n আক্ৰমণাত্মক। আপুনি প্ৰতিটো ষ্ট্ৰিং `t()` ফাংচনত মেৰিয়াই ৰাখে, অনুবাদ কী উদ্ভাৱন কৰে (`home.hero.title.v2`), সমান্তৰাল JSON ফাইল বজাই ৰাখে, আৰু আপোনাৰ কম্পোনেণ্টবোৰ স্থানীয়কৰণ বয়লাৰপ্লেটৰ সৈতে ফুলি উঠা দেখে। ই ইমানেই ক্লান্তিকৰ যে দলবোৰে আন্তৰ্জাতিকীকৰণ পিছুৱাই দিয়ে যেতিয়ালৈকে ই এটা বৃহৎ ৰিফেক্টৰ নহয়।
...
**ডেভেলপমেণ্ট:** `npm run dev` (ছ্যুড'ট্ৰান্সলেটৰ ব্যৱহাৰ কৰে, কোনো API কল নাই)

**প্ৰডাকচন:** `usePseudotranslator: false` ছেট কৰক, তাৰ পিছত `next build`

`.lingo/` ডাইৰেক্টৰী সংস্কৰণ নিয়ন্ত্ৰণত কমিট কৰক।
...
- JSX-ত অনুবাদযোগ্য পাঠৰ স্বয়ংক্ৰিয় সনাক্তকৰণ
- TypeScript সমৰ্থন
...
- `cache-only`: CI ৰ পৰা পূৰ্ব-জেনেৰেট কৰা অনুবাদ ব্যৱহাৰ কৰি প্ৰডাকচন ম'ড (কোনো API কল নাই)
...
1. **ইছ্যু:** [বাগ ৰিপ'ৰ্ট কৰক বা ফিচাৰ অনুৰোধ কৰক](https://github.com/lingodotdev/lingo.dev/issues)
2. **পুল ৰিকুৱেষ্ট:** [পৰিৱৰ্তন জমা দিয়ক](https://github.com/lingodotdev/lingo.dev/pulls)
   - প্ৰতিটো PR-ৰ বাবে এটা চেঞ্জছেটৰ প্ৰয়োজন: `pnpm new` (বা নন-ৰিলিজ পৰিৱৰ্তনৰ বাবে `pnpm new:empty`)
   - জমা দিয়াৰ আগতে পৰীক্ষা পাছ হোৱাটো নিশ্চিত কৰক
...
1. [BCP-47 ফৰ্মেট](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Locale) ব্যৱহাৰ কৰি [`i18n.json`](./i18n.json)-ত লোকেল ক'ড যোগ কৰক
2. এটা পুল ৰিকুৱেষ্ট জমা দিয়ক

**BCP-47 লোকেল ফৰ্মেট:** `language[-Script][-REGION]`

- `language`: ISO 639-1/2/3 (সৰু আখৰ): `en`, `zh`, `bho`
- `Script`: ISO 15924 (টাইটেল কেছ): `Hans`, `Hant`, `Latn`
- `REGION`: ISO 3166-1 alpha-2 (ডাঙৰ আখৰ): `US`, `CN`, `IN`
- উদাহৰণ: `en`, `pt-BR`, `zh-Hans`, `sr-Cyrl-RS`
