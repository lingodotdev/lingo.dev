...
| [**Compiler**](#lingodev-compiler) | i18n wrappers کے بغیر بلڈ ٹائم React لوکلائزیشن | `withLingo()` پلگ ان               |
...
2. زبان سوئچنگ اجزاء سیٹ اپ کریں
3. خودکار لوکیل کا پتہ لگانا نافذ کریں
...
2. ترجمے کے لیے LLM فراہم کنندہ کو مواد بھیجتا ہے
...
`provider` فیلڈ اختیاری ہے (ڈیفالٹ Lingo.dev Engine)۔ حسب ضرورت LLM فراہم کنندگان کے لیے:
...
| ان پٹ                | ڈیفالٹ                                         | تفصیل                                 |
| -------------------- | ---------------------------------------------- | ------------------------------------- |
| `api-key`            | (ضروری)                                        | Lingo.dev API کلید                    |
