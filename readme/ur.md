...
| **CLI**      | Web اور mobile apps، JSON، YAML، markdown، اور مزید کے لیے one-command localization | [/cli](https://lingo.dev/cli)           |
...
آپ کے repo کو green اور آپ کی product کو multilingual رکھتا ہے بغیر manual steps کے۔
