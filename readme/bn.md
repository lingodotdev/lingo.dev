...
3. স্বয়ংক্রিয় লোকেল সনাক্তকরণ বাস্তবায়ন করুন
...
`init` কমান্ড একটি `i18n.json` ফাইল তৈরি করে। লোকেল এবং বাকেট কনফিগার করুন:
...
2. PR ওয়ার্কফ্লোর জন্য: Settings > Actions > General-এ "Allow GitHub Actions to create and approve pull requests" সক্ষম করুন
...
| `parallel`           | `false`                                        | প্যারালাল প্রসেসিং সক্ষম করুন          |
...
ঐতিহ্যবাহী i18n আক্রমণাত্মক। আপনি প্রতিটি স্ট্রিংকে `t()` ফাংশনে মোড়ান, অনুবাদ কী উদ্ভাবন করেন (`home.hero.title.v2`), সমান্তরাল JSON ফাইল রক্ষণাবেক্ষণ করেন এবং আপনার কম্পোনেন্টগুলি লোকালাইজেশন বয়লারপ্লেটে ফুলে যেতে দেখেন। এটি এতটাই ক্লান্তিকর যে টিমগুলি আন্তর্জাতিকীকরণ বিলম্বিত করে যতক্ষণ না এটি একটি বিশাল রিফ্যাক্টরে পরিণত হয়।
...
- কোনো `t()` ফাংশন বা `<T>` র্যাপার কম্পোনেন্ট নেই
...
1. [BCP-47 ফরম্যাট](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Locale) ব্যবহার করে [`i18n.json`](./i18n.json)-এ লোকেল কোড যোগ করুন
