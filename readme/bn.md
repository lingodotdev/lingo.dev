...
<p align="center">
  <strong>⚡️ এআই-চালিত, ওপেন-সোর্স i18n টুলকিট এলএলএম দিয়ে তাৎক্ষণিক লোকালাইজেশনের জন্য।</strong>
</p>
...
**Lingo.dev কম্পাইলার** একটি ফ্রি, ওপেন-সোর্স কম্পাইলার মিডলওয়্যার, যা বিদ্যমান React কম্পোনেন্টগুলিতে কোনো পরিবর্তন না করেই বিল্ড টাইমে যেকোনো React অ্যাপকে বহুভাষিক করার জন্য ডিজাইন করা হয়েছে।
...
এটি প্রতিটি স্ট্রিংয়ের ফিঙ্গারপ্রিন্ট তৈরি করে, ফলাফল ক্যাশে রাখে, এবং শুধুমাত্র পরিবর্তিত অংশগুলি পুনরায় অনুবাদ করে।
