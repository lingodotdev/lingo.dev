...
ঐতিহ্যবাহী i18n আক্রমণাত্মক। আপনি প্রতিটি স্ট্রিংকে `t()` ফাংশনে মোড়ান, অনুবাদ কী উদ্ভাবন করেন (`home.hero.title.v2`), সমান্তরাল JSON ফাইল রক্ষণাবেক্ষণ করেন এবং আপনার কম্পোনেন্টগুলি লোকালাইজেশন বয়লারপ্লেটে ফুলে উঠতে দেখেন। এটি এতটাই ক্লান্তিকর যে টিমগুলি আন্তর্জাতিকীকরণ বিলম্বিত করে যতক্ষণ না এটি একটি বিশাল রিফ্যাক্টরে পরিণত হয়।
