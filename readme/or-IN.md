...
1. କନଫିଗର୍ ହୋଇଥିବା ଫାଇଲ୍ ରୁ ଅନୁବାଦଯୋଗ୍ୟ ବିଷୟବସ୍ତୁ ବାହାର କରେ
...
1. ରିପୋଜିଟୋରୀ ସିକ୍ରେଟ୍‌ରେ `LINGODOTDEV_API_KEY` ଯୋଗ କରନ୍ତୁ (Settings > Secrets and variables > Actions)
...
- `cache-only`: CI ରୁ ପୂର୍ବ-ଜେନେରେଟ ହୋଇଥିବା ଅନୁବାଦ ବ୍ୟବହାର କରି ପ୍ରଡକସନ ମୋଡ (କୌଣସି API କଲ ନାହିଁ)
