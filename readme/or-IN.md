...
1. କନଫିଗର୍ ହୋଇଥିବା ଫାଇଲ୍ ରୁ ଅନୁବାଦଯୋଗ୍ୟ ବିଷୟବସ୍ତୁ ଏକ୍ସଟ୍ରାକ୍ଟ କରେ
2. ଅନୁବାଦ ପାଇଁ LLM ପ୍ରଦାତାଙ୍କୁ ବିଷୟବସ୍ତୁ ପଠାଏ
3. ଅନୁବାଦିତ ବିଷୟବସ୍ତୁକୁ ଫାଇଲସିସ୍ଟମ୍‌କୁ ଲେଖେ
4. ସମ୍ପୂର୍ଣ୍ଣ ଅନୁବାଦ ଟ୍ରାକ୍ କରିବାକୁ `i18n.lock` ଫାଇଲ୍ ସୃଷ୍ଟି କରେ (ଅନାବଶ୍ୟକ ପ୍ରକ୍ରିୟାକରଣ ଏଡାଏ)
...
`provider` ଫିଲ୍ଡ ଐଚ୍ଛିକ (ଡିଫଲ୍ଟ Lingo.dev Engine)। କଷ୍ଟମ୍ LLM ପ୍ରଦାତାଙ୍କ ପାଇଁ:
...
1. ରିପୋଜିଟୋରୀ ସିକ୍ରେଟ୍‌ରେ `LINGODOTDEV_API_KEY` ଯୋଡନ୍ତୁ (Settings > Secrets and variables > Actions)
...
| -------------------- | ---------------------------------------------- | ----------------------------------------------- |
| `api-key`            | (ଆବଶ୍ୟକ)                                       | Lingo.dev API କୀ                                |
...
- JSX ରେ ଅନୁବାଦଯୋଗ୍ୟ ଟେକ୍ସଟର ସ୍ୱୟଂଚାଳିତ ଚିହ୍ନଟ
- TypeScript ସମର୍ଥନ
...
- `real`: LLM ବ୍ୟବହାର କରି ପ୍ରକୃତ ଅନୁବାଦ ସୃଷ୍ଟି କରନ୍ତୁ
- `cache-only`: CI ରୁ ପୂର୍ବ-ସୃଷ୍ଟି ଅନୁବାଦ ବ୍ୟବହାର କରି ପ୍ରଡକସନ ମୋଡ (କୌଣସି API କଲ ନାହିଁ)
...
1. [BCP-47 ଫର୍ମାଟ](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Locale) ବ୍ୟବହାର କରି [`i18n.json`](./i18n.json) ରେ ଲୋକେଲ କୋଡ ଯୋଗ କରନ୍ତୁ
