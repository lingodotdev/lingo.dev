...
1. ଲୋକେଲ୍-ଆଧାରିତ ରାଉଟିଂ ବିନ୍ୟାସ କରନ୍ତୁ (ଯଥା, `/en`, `/es`, `/pt-BR`)
2. ଭାଷା ସୁଇଚିଂ କମ୍ପୋନେଣ୍ଟ୍ ସେଟଅପ୍ କରନ୍ତୁ
3. ସ୍ୱୟଂଚାଳିତ ଲୋକେଲ୍ ଚିହ୍ନଟ କାର୍ଯ୍ୟକାରୀ କରନ୍ତୁ
4. ଆବଶ୍ୟକ ବିନ୍ୟାସ ଫାଇଲ୍ ସୃଷ୍ଟି କରନ୍ତୁ
...
1. ବିନ୍ୟାସିତ ଫାଇଲରୁ ଅନୁବାଦଯୋଗ୍ୟ ବିଷୟବସ୍ତୁ ବାହାର କରେ
2. ଅନୁବାଦ ପାଇଁ LLM ପ୍ରଦାତାଙ୍କୁ ବିଷୟବସ୍ତୁ ପଠାଏ
3. ଅନୁବାଦିତ ବିଷୟବସ୍ତୁକୁ ଫାଇଲସିସ୍ଟମକୁ ଫେରାଇ ଲେଖେ
4. ସମ୍ପୂର୍ଣ୍ଣ ଅନୁବାଦଗୁଡ଼ିକୁ ଟ୍ରାକ୍ କରିବା ପାଇଁ `i18n.lock` ଫାଇଲ୍ ସୃଷ୍ଟି କରେ (ଅନାବଶ୍ୟକ ପ୍ରକ୍ରିୟାକରଣକୁ ଏଡ଼ାଇଥାଏ)

**କନଫିଗରେସନ୍:**

`init` କମାଣ୍ଡ ଏକ `i18n.json` ଫାଇଲ୍ ସୃଷ୍ଟି କରେ। ଲୋକେଲ୍ ଏବଂ ବକେଟ୍ ବିନ୍ୟାସ କରନ୍ତୁ:
...
| `pull-request-title` | `"feat: update translations via @LingoDotDev"` | କଷ୍ଟମ୍ PR ଶୀର୍ଷକ                                |
