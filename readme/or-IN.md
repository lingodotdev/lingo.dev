...
1. କନଫିଗର୍ ହୋଇଥିବା ଫାଇଲରୁ ଅନୁବାଦଯୋଗ୍ୟ ବିଷୟବସ୍ତୁ ବାହାର କରେ
2. ଅନୁବାଦ ପାଇଁ LLM ପ୍ରଦାତାଙ୍କୁ ବିଷୟବସ୍ତୁ ପଠାଏ
3. ଅନୁବାଦିତ ବିଷୟବସ୍ତୁକୁ ଫାଇଲସିସ୍ଟମକୁ ଫେରାଇ ଲେଖେ
4. ସମ୍ପୂର୍ଣ୍ଣ ଅନୁବାଦକୁ ଟ୍ରାକ୍ କରିବା ପାଇଁ `i18n.lock` ଫାଇଲ୍ ସୃଷ୍ଟି କରେ (ଅନାବଶ୍ୟକ ପ୍ରକ୍ରିୟାକରଣକୁ ଏଡାଏ)
...
ପାରମ୍ପରିକ i18n ଆକ୍ରମଣାତ୍ମକ ଅଟେ। ଆପଣ ପ୍ରତ୍ୟେକ ଷ୍ଟ୍ରିଂକୁ `t()` ଫଙ୍କସନରେ ଗୁଡ଼ାନ୍ତି, ଅନୁବାଦ କି (`home.hero.title.v2`) ଉଦ୍ଭାବନ କରନ୍ତି, ସମାନ୍ତରାଳ JSON ଫାଇଲଗୁଡ଼ିକ ରକ୍ଷଣାବେକ୍ଷଣ କରନ୍ତି, ଏବଂ ଆପଣଙ୍କ କମ୍ପୋନେଣ୍ଟଗୁଡ଼ିକ ଲୋକାଲାଇଜେସନ ବଏଲରପ୍ଲେଟରେ ଫୁଲିଯିବାର ଦେଖନ୍ତି। ଏହା ଏତେ କ୍ଲାନ୍ତିକର ଯେ ଟିମଗୁଡ଼ିକ ଆନ୍ତର୍ଜାତୀକରଣକୁ ବିଳମ୍ବ କରନ୍ତି ଯେପର୍ଯ୍ୟନ୍ତ ଏହା ଏକ ବୃହତ୍ ରିଫ୍ୟାକ୍ଟରରେ ପରିଣତ ହୁଏ।
