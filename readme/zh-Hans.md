...
| **CLI**      | 一键本地化网页和移动应用，支持 JSON、YAML、Markdown 等多种格式                 | [/cli](https://lingo.dev/cli)           |
| **CI/CD**    | 每次推送时自动提交翻译，并在需要时创建拉取请求                                 | [/ci](https://lingo.dev/ci)             |
...
它会为每个字符串生成指纹，缓存结果，并仅重新翻译发生更改的内容。
