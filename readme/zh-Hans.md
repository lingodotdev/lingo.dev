...
运行`next build`，即可自动生成西班牙语和法语的构建包 ✨

[阅读文档 →](https://lingo.dev/compiler) 获取完整指南，或[加入我们的 Discord](https://lingo.dev/go/discord) 获取配置帮助。
...
它会为每个字符串生成指纹，缓存结果，仅重新翻译发生变化的内容。
...
如果你喜欢我们的项目，欢迎为我们点亮一颗 ⭐，助力我们达成 10,000 stars！🌟
