...
2. භාෂා මාරු කිරීමේ components පිහිටුවන්න
...
| -------------------- | ---------------------------------------------- | -------------------------------------------- |
| `api-key`            | (අවශ්‍යයි)                                     | Lingo.dev API key                            |
