...
1. locale-පාදක routing වින්‍යාස කරන්න (උදා., `/en`, `/es`, `/pt-BR`)
...
3. පරිවර්තනය කළ අන්තර්ගතය filesystem වෙත නැවත ලියයි
...
`provider` ක්ෂේත්‍රය විකල්ප වේ (පෙරනිමිය Lingo.dev Engine වෙත). අභිරුචි LLM සපයන්නන් සඳහා:
...
| -------------------- | ---------------------------------------------- | -------------------------------------------- |
| `api-key`            | (අවශ්‍ය)                                       | Lingo.dev API යතුර                           |
...
1. [BCP-47 ආකෘතිය](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Locale) භාවිතයෙන් [`i18n.json`](./i18n.json) වෙත locale කේතය එක් කරන්න
