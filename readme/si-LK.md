...
| ---------------------------------- | ----------------------------------------------------- | ---------------------------------- |
| [**MCP**](#lingodev-mcp)           | React යෙදුම් සඳහා AI-සහාය i18n සැකසුම                 | විමසුම: `Set up i18n`              |
| [**CLI**](#lingodev-cli)           | JSON, YAML, markdown, CSV, PO ගොනු පරිවර්තනය කරන්න    | `npx lingo.dev@latest run`         |
| [**CI/CD**](#lingodev-cicd)        | GitHub Actions හි ස්වයංක්‍රීය පරිවර්තන නල             | `uses: lingodotdev/lingo.dev@main` |
...
1. ප්‍රාදේශීය-පාදක මාර්ගගත කිරීම වින්‍යාස කරන්න (උදා., `/en`, `/es`, `/pt-BR`)
2. භාෂා මාරු කිරීමේ සංරචක සකසන්න
3. ස්වයංක්‍රීය ප්‍රාදේශීය හඳුනාගැනීම ක්‍රියාත්මක කරන්න
...
4. සම්පූර්ණ කළ පරිවර්තන නිරීක්ෂණය කිරීමට `i18n.lock` ගොනුව නිර්මාණය කරයි (අතිරික්ත සැකසීම් වළක්වයි)

**වින්‍යාසය:**

`init` විධානය `i18n.json` ගොනුවක් උත්පාදනය කරයි. ප්‍රාදේශීය සහ බාල්දි වින්‍යාස කරන්න:
...
2. PR කාර්ය ප්‍රවාහ සඳහා: Settings > Actions > General හි "Allow GitHub Actions to create and approve pull requests" සබල කරන්න
...
| `parallel`           | `false`                                        | සමාන්තර සැකසීම සබල කරන්න                     |
...
සාම්ප්‍රදායික i18n ආක්‍රමණශීලී වේ. ඔබ සෑම තන්තුවක්ම `t()` ශ්‍රිතවල ඔතා, පරිවර්තන යතුරු (`home.hero.title.v2`) නිර්මාණය කර, සමාන්තර JSON ගොනු නඩත්තු කර, ඔබේ සංරචක ස්ථානීයකරණ boilerplate සමඟ පුම්බා යන ආකාරය නරඹයි. එය කෙතරම් කම්මැලි කාර්යයක්ද යත්, කණ්ඩායම් එය විශාල ප්‍රතිව්‍යුහගත කිරීමක් බවට පත්වන තෙක් ජාත්‍යන්තරකරණය ප්‍රමාද කරයි.
...
- ධාවන කාල කාර්ය සාධන පිරිවැය ශුන්‍ය
...
- ඇතුළත් පරිවර්තන සංස්කාරක widget
...
- `cache-only`: CI වෙතින් පෙර-උත්පාදිත පරිවර්තන භාවිතා කරන නිෂ්පාදන ප්‍රකාරය (API ඇමතුම් නැත)
...
2. **Pull Requests:** [වෙනස්කම් ඉදිරිපත් කරන්න](https://github.com/lingodotdev/lingo.dev/pulls)
   - සෑම PR එකකටම changeset අවශ්‍ය වේ: `pnpm new` (හෝ නිකුතු නොවන වෙනස්කම් සඳහා `pnpm new:empty`)
...
1. [BCP-47 ආකෘතිය](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Locale) භාවිතයෙන් [`i18n.json`](./i18n.json) වෙත ප්‍රදේශ කේතය එක් කරන්න
2. Pull request එකක් ඉදිරිපත් කරන්න

**BCP-47 ප්‍රදේශ ආකෘතිය:** `language[-Script][-REGION]`

- `language`: ISO 639-1/2/3 (කුඩා අකුරු): `en`, `zh`, `bho`
- `Script`: ISO 15924 (මාතෘකා අකුරු): `Hans`, `Hant`, `Latn`
