...
4. අවශ්‍ය වින්‍යාස ගොනු ජනනය කරන්න
...
`init` විධානය `i18n.json` ගොනුවක් ජනනය කරයි. ප්‍රාදේශීය සහ බාල්දි වින්‍යාස කරන්න:
...
1. ගබඩා රහස් වලට `LINGODOTDEV_API_KEY` එක් කරන්න (Settings > Secrets and variables > Actions)
...
- `pseudotranslator`: ස්ථාන දරණ පරිවර්තන සමඟ සංවර්ධන ප්‍රකාරය (API පිරිවැය නැත)
