...
> **සටහන:** ඔබ පැරණි සම්පාදකය (`@lingo.dev/_compiler`) භාවිතා කරන්නේ නම්, කරුණාකර `@lingo.dev/compiler` වෙත සංක්‍රමණය වන්න. පැරණි සම්පාදකය අත්හිටුවා ඇති අතර අනාගත නිකුතුවකදී ඉවත් කරනු ලැබේ.
...
ඔබේ build config හි සක්‍රීය කරන්න:
...
`next build` ධාවනය කර ස්පාඤ්ඤ සහ ප්‍රංශ bundle ඉස්මතු වන ආකාරය නරඹන්න ✨

සම්පූර්ණ මාර්ගෝපදේශය සඳහා [ලේඛන කියවන්න →](https://lingo.dev/compiler), සහ ඔබේ setup සඳහා උදව් ලබා ගැනීමට [අපගේ Discord වෙත එක්වන්න](https://lingo.dev/go/discord).

---

### මෙම repo එක තුළ ඇත්තේ කුමක්ද?

| මෙවලම        | TL;DR                                                                                       | ලේඛන                                    |
| ------------ | ------------------------------------------------------------------------------------------- | --------------------------------------- |
| **Compiler** | Build-time React ප්‍රාදේශීයකරණය                                                             | [/compiler](https://lingo.dev/compiler) |
| **CLI**      | වෙබ් සහ ජංගම යෙදුම්, JSON, YAML, markdown සහ තවත් බොහෝ දේ සඳහා එක් විධානයෙන් ප්‍රාදේශීයකරණය | [/cli](https://lingo.dev/cli)           |
| **CI/CD**    | සෑම push එකකම ස්වයංක්‍රීය-commit පරිවර්තන + අවශ්‍ය නම් pull requests නිර්මාණය කරන්න         | [/ci](https://lingo.dev/ci)             |
| **SDK**      | පරිශීලක-ජනනය කළ අන්තර්ගතය සඳහා තත්‍ය කාලීන පරිවර්තනය                                        | [/sdk](https://lingo.dev/sdk)           |

පහත දැක්වෙන්නේ එක් එක් සඳහා ඉක්මන් කරුණු 👇
...
පරිපූර්ණ පරිවර්තන ස්වයංක්‍රීයව නැව්ගත කරන්න.
...
අතින් කළ යුතු පියවර නොමැතිව ඔබේ repo එක හරිත සහ ඔබේ නිෂ්පාදනය බහුභාෂා ලෙස තබා ගනී.
...
ගතික අන්තර්ගතය සඳහා ක්ෂණික ඉල්ලීම-අනුව පරිවර්තනය.
...
අපි ප්‍රජාව මත පදනම් වූ අතර දායකත්වයන්ට ආදරය කරමු!
...
අපි කරන දේ ඔබට කැමති නම්, අපට ⭐ එකක් දී තරු 10,000ක් කරා ළඟා වීමට අපට උදව් කරන්න! 🌟
...
ඔබේ භාෂාව නොපෙනේද? එය [`i18n.json`](./i18n.json) වෙත එකතු කර PR එකක් විවෘත කරන්න!
...
- අක්ෂර පද්ධතිය: ISO 15924 title case (`Hans`, `Hant`, `Latn`)
- කලාපය: ISO 3166-1 alpha-2 උපරිම අකුරු (`US`, `CN`, `IN`)
