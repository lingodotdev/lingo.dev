...
பாரம்பரிய i18n ஊடுருவக்கூடியது. நீங்கள் ஒவ்வொரு சரத்தையும் `t()` செயல்பாடுகளில் சுற்றி, மொழிபெயர்ப்பு விசைகளை உருவாக்கி (`home.hero.title.v2`), இணையான JSON கோப்புகளை பராமரித்து, உங்கள் கூறுகள் உள்ளூர்மயமாக்கல் boilerplate உடன் வீங்குவதைப் பார்க்கிறீர்கள். இது மிகவும் சலிப்பானது, குழுக்கள் சர்வதேசமயமாக்கலை ஒத்திவைக்கின்றன, அது பெரிய மறுசீரமைப்பாக மாறும் வரை.
...
1. [BCP-47 வடிவத்தைப்](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Locale) பயன்படுத்தி [`i18n.json`](./i18n.json) இல் locale குறியீட்டைச் சேர்க்கவும்
2. pull request ஐச் சமர்ப்பிக்கவும்

**BCP-47 locale வடிவம்:** `language[-Script][-REGION]`
