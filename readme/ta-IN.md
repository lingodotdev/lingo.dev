...
1. locale-அடிப்படையிலான routing ஐ கட்டமைக்கவும் (எ.கா., `/en`, `/es`, `/pt-BR`)
2. மொழி மாற்று கூறுகளை அமைக்கவும்
3. தானியங்கு locale கண்டறிதலை செயல்படுத்தவும்
4. தேவையான கட்டமைப்பு கோப்புகளை உருவாக்கவும்
...
1. repository secrets க்கு `LINGODOTDEV_API_KEY` ஐ சேர்க்கவும் (Settings > Secrets and variables > Actions)
...
| `working-directory`  | `"."`                                          | இயக்க வேண்டிய டைரக்டரி                            |
...
**மேம்பாடு:** `npm run dev` (pseudotranslator ஐப் பயன்படுத்துகிறது, API அழைப்புகள் இல்லை)

**உற்பத்தி:** `usePseudotranslator: false` ஐ அமைக்கவும், பின்னர் `next build`

`.lingo/` அடைவை பதிப்புக் கட்டுப்பாட்டில் commit செய்யவும்.
...
- `pseudotranslator`: placeholder மொழிபெயர்ப்புகளுடன் மேம்பாட்டு பயன்முறை (API செலவுகள் இல்லை)
