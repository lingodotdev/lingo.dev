...
| [**SDK**](#lingodev-sdk)           | டைனமிக் உள்ளடக்கத்திற்கான இயக்க நேர மொழிபெயர்ப்பு        | `npm install lingo.dev`            |
...
1. locale-அடிப்படையிலான routing ஐ உள்ளமைக்கவும் (எ.கா., `/en`, `/es`, `/pt-BR`)
...
3. மொழிபெயர்க்கப்பட்ட உள்ளடக்கத்தை filesystem இல் மீண்டும் எழுதுகிறது
...
1. repository secrets இல் `LINGODOTDEV_API_KEY` ஐ சேர்க்கவும் (Settings > Secrets and variables > Actions)
...
| `pull-request`       | `false`                                        | நேரடியாக commit செய்வதற்கு பதிலாக PR ஐ உருவாக்கவும் |
...
| `working-directory`  | `"."`                                          | இயக்க வேண்டிய directory                             |
...
பாரம்பரிய i18n ஊடுருவக்கூடியது. ஒவ்வொரு சரத்தையும் `t()` செயல்பாடுகளில் சுற்றி, மொழிபெயர்ப்பு விசைகளை (`home.hero.title.v2`) கண்டுபிடித்து, இணையான JSON கோப்புகளை பராமரித்து, உங்கள் கூறுகள் உள்ளூர்மயமாக்கல் boilerplate உடன் வீங்குவதைப் பார்க்கிறீர்கள். இது மிகவும் சலிப்பானது, குழுக்கள் சர்வதேசமயமாக்கலை ஒத்திவைக்கின்றன, அது பெரிய refactor ஆக மாறும் வரை.
