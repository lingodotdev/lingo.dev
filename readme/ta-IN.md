...
| [**CLI**](#lingodev-cli)           | JSON, YAML, markdown, CSV, PO கோப்புகளை மொழிபெயர்         | `npx lingo.dev@latest run`         |
| [**CI/CD**](#lingodev-cicd)        | GitHub Actions இல் தானியங்கு மொழிபெயர்ப்பு பைப்லைன்       | `uses: lingodotdev/lingo.dev@main` |
| [**SDK**](#lingodev-sdk)           | டைனமிக் உள்ளடக்கத்திற்கான ரன்டைம் மொழிபெயர்ப்பு           | `npm install lingo.dev`            |
| [**Compiler**](#lingodev-compiler) | i18n wrappers இல்லாமல் பில்ட்-டைம் React உள்ளூர்மயமாக்கல் | `withLingo()` plugin               |
...
1. லொகேல்-அடிப்படையிலான ரூட்டிங்கை உள்ளமைக்கவும் (எ.கா., `/en`, `/es`, `/pt-BR`)
2. மொழி மாற்று கூறுகளை அமைக்கவும்
3. தானியங்கு லொகேல் கண்டறிதலை செயல்படுத்தவும்
4. தேவையான உள்ளமைவு கோப்புகளை உருவாக்கவும்
...
1. உள்ளமைக்கப்பட்ட கோப்புகளிலிருந்து மொழிபெயர்க்கக்கூடிய உள்ளடக்கத்தை பிரித்தெடுக்கிறது
2. மொழிபெயர்ப்புக்காக LLM வழங்குநருக்கு உள்ளடக்கத்தை அனுப்புகிறது
3. மொழிபெயர்க்கப்பட்ட உள்ளடக்கத்தை கோப்பு அமைப்புக்கு மீண்டும் எழுதுகிறது
4. முடிக்கப்பட்ட மொழிபெயர்ப்புகளை கண்காணிக்க `i18n.lock` கோப்பை உருவாக்குகிறது (தேவையற்ற செயலாக்கத்தை தவிர்க்கிறது)

**கட்டமைப்பு:**

`init` கட்டளை ஒரு `i18n.json` கோப்பை உருவாக்குகிறது. லொகேல்கள் மற்றும் பக்கெட்களை உள்ளமைக்கவும்:
...
`provider` புலம் விருப்பமானது (இயல்புநிலை Lingo.dev Engine). தனிப்பயன் LLM வழங்குநர்களுக்கு:
...
1. ரெப்பசிட்டரி சீக்ரெட்களில் `LINGODOTDEV_API_KEY` ஐ சேர்க்கவும் (Settings > Secrets and variables > Actions)
2. PR வொர்க்ஃப்ளோக்களுக்கு: Settings > Actions > General இல் "Allow GitHub Actions to create and approve pull requests" ஐ இயக்கவும்
...
| இன்புட்              | இயல்புநிலை                                     | விளக்கம்                                         |
| -------------------- | ---------------------------------------------- | ------------------------------------------------ |
| `api-key`            | (தேவையானது)                                    | Lingo.dev API கீ                                 |
| `pull-request`       | `false`                                        | நேரடியாக கமிட் செய்வதற்கு பதிலாக PR உருவாக்கவும் |
| `commit-message`     | `"feat: update translations via @LingoDotDev"` | தனிப்பயன் கமிட் செய்தி                           |
...
பாரம்பரிய i18n ஊடுருவக்கூடியது. நீங்கள் ஒவ்வொரு சரத்தையும் `t()` செயல்பாடுகளில் சுற்றி, மொழிபெயர்ப்பு விசைகளை உருவாக்கி (`home.hero.title.v2`), இணை JSON கோப்புகளை பராமரித்து, உங்கள் கூறுகள் உள்ளூர்மயமாக்கல் boilerplate உடன் வீங்குவதைப் பார்க்கிறீர்கள். இது மிகவும் சலிப்பானது, குழுக்கள் சர்வதேசமயமாக்கலை ஒத்திவைக்கின்றன, அது பெரிய மறுசீரமைப்பாக மாறும் வரை.
...
**உருவாக்கம்:** `npm run dev` (pseudotranslator ஐப் பயன்படுத்துகிறது, API அழைப்புகள் இல்லை)

**உற்பத்தி:** `usePseudotranslator: false` ஐ அமைக்கவும், பின்னர் `next build`

`.lingo/` அடைவை பதிப்பு கட்டுப்பாட்டில் commit செய்யவும்.

**முக்கிய அம்சங்கள்:**

- இயக்க நேர செயல்திறன் செலவு இல்லை
- மொழிபெயர்ப்பு விசைகள் அல்லது JSON கோப்புகள் இல்லை
- `t()` செயல்பாடுகள் அல்லது `<T>` wrapper கூறுகள் இல்லை
- JSX இல் மொழிபெயர்க்கக்கூடிய உரையின் தானியங்கு கண்டறிதல்
- TypeScript ஆதரவு
- பன்மைகளுக்கான ICU MessageFormat
- `data-lingo-override` பண்புக்கூறு வழியாக கைமுறை மேலெழுதுதல்கள்
- உள்ளமைக்கப்பட்ட மொழிபெயர்ப்பு எடிட்டர் விட்ஜெட்

**Build modes:**

- `pseudotranslator`: placeholder மொழிபெயர்ப்புகளுடன் உருவாக்க பயன்முறை (API செலவுகள் இல்லை)
- `real`: LLM களைப் பயன்படுத்தி உண்மையான மொழிபெயர்ப்புகளை உருவாக்கவும்
- `cache-only`: CI இலிருந்து முன்-உருவாக்கப்பட்ட மொழிபெயர்ப்புகளைப் பயன்படுத்தி உற்பத்தி பயன்முறை (API அழைப்புகள் இல்லை)
...
3. **உருவாக்கம்:** இது ஒரு pnpm + turborepo monorepo
...
1. [BCP-47 வடிவமைப்பைப்](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Locale) பயன்படுத்தி [`i18n.json`](./i18n.json) இல் locale குறியீட்டைச் சேர்க்கவும்
2. pull request ஐச் சமர்ப்பிக்கவும்

**BCP-47 locale வடிவமைப்பு:** `language[-Script][-REGION]`

- `language`: ISO 639-1/2/3 (சிறிய எழுத்துக்கள்): `en`, `zh`, `bho`
- `Script`: ISO 15924 (தலைப்பு வழக்கு): `Hans`, `Hant`, `Latn`
- `REGION`: ISO 3166-1 alpha-2 (பெரிய எழுத்துக்கள்): `US`, `CN`, `IN`
