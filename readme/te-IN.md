...
2. **పుల్ రిక్వెస్ట్‌లు:** [మార్పులను సబ్మిట్ చేయండి](https://github.com/lingodotdev/lingo.dev/pulls)
   - ప్రతి PRకు చేంజ్‌సెట్ అవసరం: `pnpm new` (లేదా రిలీజ్ కాని మార్పుల కోసం `pnpm new:empty`)
...
- `language`: ISO 639-1/2/3 (చిన్నబడి): `en`, `zh`, `bho`
- `Script`: ISO 15924 (టైటిల్ కేస్): `Hans`, `Hant`, `Latn`
- `REGION`: ISO 3166-1 alpha-2 (పెద్దబడి): `US`, `CN`, `IN`
