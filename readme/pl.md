...
Tradycyjne i18n jest inwazyjne. Każdy string opakowujesz w funkcje `t()`, wymyślasz klucze tłumaczeń (`home.hero.title.v2`), utrzymujesz równoległe pliki JSON i obserwujesz, jak komponenty puchną od boilerplate'u lokalizacyjnego. To tak żmudne, że zespoły odkładają internacjonalizację, aż staje się to ogromnym refaktorem.
...
1. **Zgłoszenia:** [Zgłoś błąd lub poproś o funkcję](https://github.com/lingodotdev/lingo.dev/issues)
