...
| `pull-request`       | `false`                                        | Tworzenie PR zamiast bezpośredniego commitowania |
...
- Zero kosztów wydajnościowych w runtime
...
- Wbudowany widget edytora tłumaczeń
...
1. **Zgłoszenia:** [Zgłoś błędy lub poproś o funkcje](https://github.com/lingodotdev/lingo.dev/issues)
2. **Pull Requesty:** [Zgłoś zmiany](https://github.com/lingodotdev/lingo.dev/pulls)
   - Każdy PR wymaga changeset: `pnpm new` (lub `pnpm new:empty` dla zmian niepublikowanych)
   - Upewnij się, że testy przechodzą przed zgłoszeniem
...
**Format języka BCP-47:** `language[-Script][-REGION]`
