...
| [**CI/CD**](#lingodev-cicd)        | Zautomatyzowany pipeline tłumaczeń w GitHub Actions      | `uses: lingodotdev/lingo.dev@main` |
...
4. Wygeneruj niezbędne pliki konfiguracyjne
...
4. Tworzy plik `i18n.lock` do śledzenia ukończonych tłumaczeń (zapobiega powielaniu przetwarzania)
