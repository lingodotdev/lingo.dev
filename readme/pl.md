...
| ---------------------------------- | -------------------------------------------------------- | ---------------------------------- |
| [**MCP**](#lingodev-mcp)           | AI-wspomagane wdrożenie i18n dla aplikacji React         | Prompt: `Set up i18n`              |
...
Pole opcjonalne `provider` (domyślnie Lingo.dev Engine). Dla własnych dostawców LLM:
...
1. **Issues:** [Zgłoś błąd lub poproś o funkcję](https://github.com/lingodotdev/lingo.dev/issues)
2. **Pull Requests:** [Zgłoś zmiany](https://github.com/lingodotdev/lingo.dev/pulls)
