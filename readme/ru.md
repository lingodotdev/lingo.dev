...
[Читать документацию →](https://lingo.dev/compiler) для полного руководства.
...
| **CI/CD**    | Автоматическое добавление переводов при каждом пуше + создание pull-запросов при необходимости | [/ci](https://lingo.dev/ci)             |
| **SDK**      | Перевод в реальном времени для контента, созданного пользователями            | [/sdk](https://lingo.dev/sdk)           |

Ниже представлены краткие описания для каждого инструмента 👇
...
[Читать документацию →](https://lingo.dev/cli)
...
Поддерживает ваш репозиторий зелёным и ваш продукт многоязычным без ручных действий.
...
Мы ориентированы на сообщество и любим вклад участников!
