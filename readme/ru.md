...
Запустите `next build` и смотрите, как появляются бандлы для испанского и французского ✨

[Читайте документацию →](https://lingo.dev/compiler) для полного гайда и [заходите в наш Discord](https://lingo.dev/go/discord), чтобы получить помощь с настройкой.
...
| **CI/CD**    | Авто-коммит переводов при каждом пуше + создание pull request при необходимости       | [/ci](https://lingo.dev/ci)             |
| **SDK**      | Перевод в реальном времени для пользовательского контента                             | [/sdk](https://lingo.dev/sdk)           |

Ниже — быстрый обзор каждого инструмента 👇
...
Он делает отпечатки всех строк, кэширует результаты и переводит только то, что изменилось.
...
Ваша репа всегда зелёная, а продукт — многоязычный, без ручных шагов.

[Читайте документацию →](https://lingo.dev/ci)
...
Мы развиваемся вместе с комьюнити и всегда рады вашим идеям!
...
Если вам нравится, что мы делаем, поставьте ⭐ и помогите нам дойти до 10 000 звёзд! 🌟
