...
| साधन                               | वापराचे क्षेत्र                                  | द्रुत आदेश                         |
| ---------------------------------- | ------------------------------------------------ | ---------------------------------- |
| [**MCP**](#lingodev-mcp)           | React apps साठी AI-सहाय्यित i18n सेटअप           | प्रॉम्प्ट: `Set up i18n`           |
...
| [**Compiler**](#lingodev-compiler) | i18n wrappers शिवाय बिल्ड-टाइम React स्थानिकीकरण | `withLingo()` प्लगइन               |
...
तुमच्या IDE मध्ये MCP सर्व्हर कॉन्फिगर केल्यानंतर ([क्विकस्टार्ट मार्गदर्शक पहा](https://lingo.dev/en/mcp)), तुमच्या असिस्टंटला प्रॉम्प्ट करा:
...
1. locale-आधारित राउटिंग कॉन्फिगर करा (उदा., `/en`, `/es`, `/pt-BR`)
2. भाषा स्विचिंग कंपोनेंट्स सेट अप करा
3. स्वयंचलित locale शोध लागू करा
...
1. कॉन्फिगर केलेल्या फाइल्समधून भाषांतर करण्यायोग्य कंटेंट एक्स्ट्रॅक्ट करते
2. भाषांतरासाठी LLM प्रोव्हायडरला कंटेंट पाठवते
3. भाषांतरित कंटेंट फाइलसिस्टममध्ये परत लिहिते
4. पूर्ण झालेल्या भाषांतरांचा मागोवा ठेवण्यासाठी `i18n.lock` फाइल तयार करते (अनावश्यक प्रोसेसिंग टाळते)

**कॉन्फिगरेशन:**

`init` आदेश `i18n.json` फाइल जनरेट करतो. locales आणि buckets कॉन्फिगर करा:
...
1. रिपॉझिटरी secrets मध्ये `LINGODOTDEV_API_KEY` जोडा (Settings > Secrets and variables > Actions)
2. PR workflows साठी: Settings > Actions > General मध्ये "Allow GitHub Actions to create and approve pull requests" सक्षम करा
...
| `parallel`           | `false`                                        | समांतर प्रोसेसिंग सक्षम करा       |
...
पारंपरिक i18n आक्रमक आहे. तुम्ही प्रत्येक स्ट्रिंगला `t()` फंक्शन्समध्ये गुंडाळता, भाषांतर की शोधता (`home.hero.title.v2`), समांतर JSON फाइल्स व्यवस्थापित करता आणि तुमचे कंपोनेंट्स स्थानिकीकरण बॉयलरप्लेटने फुगलेले पाहता. हे इतके कंटाळवाणे आहे की टीम्स आंतरराष्ट्रीयीकरण विलंबित करतात जोपर्यंत ते मोठ्या रिफॅक्टरमध्ये बदलत नाही.
...
- शून्य रनटाइम परफॉर्मन्स खर्च
- भाषांतर की किंवा JSON फाइल्स नाहीत
- `t()` फंक्शन्स किंवा `<T>` रॅपर कंपोनेंट्स नाहीत
- JSX मध्ये भाषांतर करण्यायोग्य मजकूराचा स्वयंचलित शोध
- TypeScript सपोर्ट
- अनेकवचनांसाठी ICU MessageFormat
- `data-lingo-override` विशेषतेद्वारे मॅन्युअल ओव्हरराइड्स
- अंतर्भूत भाषांतर संपादक विजेट

**बिल्ड मोड्स:**

- `pseudotranslator`: प्लेसहोल्डर भाषांतरांसह डेव्हलपमेंट मोड (API खर्च नाही)
- `real`: LLM वापरून वास्तविक भाषांतरे व्युत्पन्न करा
- `cache-only`: CI मधून पूर्व-व्युत्पन्न केलेली भाषांतरे वापरून प्रोडक्शन मोड (API कॉल्स नाहीत)
...
[डॉक्युमेंटेशन वाचा →](https://lingo.dev/en/compiler)
...
2. **पुल रिक्वेस्ट्स:** [बदल सबमिट करा](https://github.com/lingodotdev/lingo.dev/pulls)
   - प्रत्येक PR ला चेंजसेट आवश्यक आहे: `pnpm new` (किंवा नॉन-रिलीज बदलांसाठी `pnpm new:empty`)
...
1. [BCP-47 फॉरमॅट](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Locale) वापरून [`i18n.json`](./i18n.json) मध्ये लोकेल कोड जोडा
