...
[डॉक्स वाचा →](https://lingo.dev/compiler) संपूर्ण मार्गदर्शनासाठी, आणि तुमच्या सेटअपमध्ये मदत मिळवण्यासाठी [आमच्या Discord मध्ये सामील व्हा](https://lingo.dev/go/discord).
...
हे प्रत्येक स्ट्रिंगचे फिंगरप्रिंट करते, परिणाम कॅश करते आणि फक्त बदललेल्या गोष्टींचे पुन्हा भाषांतर करते.
...
तुमचा रेपो ग्रीन आणि तुमचे उत्पादन मॅन्युअल स्टेप्सशिवाय बहुभाषिक ठेवते.
...
चॅट, यूझर कमेंट्स आणि इतर रिअल-टाइम फ्लोसाठी परफेक्ट.
...
- काही कल्पना आहे? [इश्यू उघडा](https://github.com/lingodotdev/lingo.dev/issues)
...
जर तुम्हाला आमचे काम आवडत असेल, तर आम्हाला ⭐ द्या आणि 10,000 स्टार्स गाठण्यात आमची मदत करा! 🌟
...
**Locale स्वरूप:** [BCP-47](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Locale) कोड वापरा: `language[-Script][-REGION]`
