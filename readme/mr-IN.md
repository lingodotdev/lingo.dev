...
2. भाषा स्विचिंग घटक सेट अप करा
3. स्वयंचलित लोकेल शोध लागू करा
...
2. भाषांतरासाठी LLM प्रदात्याकडे कंटेंट पाठवते
3. भाषांतरित कंटेंट फाइलसिस्टममध्ये परत लिहिते
4. पूर्ण झालेल्या भाषांतरांचा मागोवा ठेवण्यासाठी `i18n.lock` फाइल तयार करते (अनावश्यक प्रक्रिया टाळते)

**कॉन्फिगरेशन:**

`init` आदेश `i18n.json` फाइल जनरेट करतो. लोकेल आणि बकेट कॉन्फिगर करा:
...
`provider` फील्ड ऐच्छिक आहे (डीफॉल्ट Lingo.dev Engine). कस्टम LLM प्रदात्यांसाठी:
...
| `parallel`           | `false`                                        | समांतर प्रक्रिया सक्षम करा        |
