...
> **Примітка:** Якщо ви використовуєте застарілий компілятор (`@lingo.dev/_compiler`), будь ласка, перейдіть на `@lingo.dev/compiler`. Застарілий компілятор більше не підтримується і буде видалено в майбутньому релізі.
...
Увімкніть у вашій конфігурації збірки:
...
| **CLI**      | Локалізація веб- та мобільних додатків однією командою: JSON, YAML, markdown та інше | [/cli](https://lingo.dev/cli)           |
...
Доставляйте ідеальні переклади автоматично.
...
Миттєвий переклад на запит для динамічного контенту.
