...
| [**Compiler**](#lingodev-compiler) | Локалізація React під час збірки без i18n-обгорток  | `withLingo()` плагін               |
...
4. Згенеруйте необхідні конфігураційні файли
...
Поле `provider` є опціональним (за замовчуванням Lingo.dev Engine). Для власних LLM-провайдерів:
