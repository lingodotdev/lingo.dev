...
التدويل التقليدي متطفل. تقوم بتغليف كل نص في دوال `t()`، وابتكار مفاتيح الترجمة (`home.hero.title.v2`)، وصيانة ملفات JSON موازية، ومشاهدة مكوناتك تنتفخ بشفرة التدويل الإضافية. إنها مملة للغاية لدرجة أن الفرق تؤجل التدويل حتى يصبح إعادة هيكلة ضخمة.
...
- لا توجد تكلفة أداء في وقت التشغيل
...
- `cache-only`: وضع الإنتاج باستخدام ترجمات تم إنشاؤها مسبقاً من CI (بدون استدعاءات API)
