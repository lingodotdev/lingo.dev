...
| -------------------- | ---------------------------------------------- | --------------------------------- |
| `api-key`            | (مطلوب)                                        | مفتاح API لـ Lingo.dev            |
...
التدويل التقليدي متطفل. تقوم بتغليف كل نص في دوال `t()`، وابتكار مفاتيح ترجمة (`home.hero.title.v2`)، وصيانة ملفات JSON موازية، ومشاهدة مكوناتك تنتفخ بشيفرة التوطين الإضافية. إنها مملة للغاية لدرجة أن الفرق تؤجل التدويل حتى يصبح إعادة هيكلة ضخمة.
