...
| **التكامل والتسليم المستمر**    | التزام تلقائي للترجمات مع كل دفع + إنشاء طلبات سحب إذا لزم الأمر        | [/ci](https://lingo.dev/ci)             |
...
يحافظ على مستودعك الخاص بالشفرة المصدرية أخضر ومنتجك متعدد اللغات دون الحاجة إلى خطوات يدوية.

[اقرأ الوثائق ←](https://lingo.dev/ci)

---

### 🧩 مكتبة تطوير البرمجيات من Lingo.dev
...
مثالية للدردشة، وتعليقات المستخدمين، وغيرها من تدفقات المحتوى في الوقت الفعلي.
