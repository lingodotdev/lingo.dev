...
التدويل التقليدي متطفل. تقوم بتغليف كل نص في دوال `t()`، وابتكار مفاتيح ترجمة (`home.hero.title.v2`)، وصيانة ملفات JSON موازية، ومشاهدة مكوناتك تنتفخ بشيفرة التدويل الإضافية. إنها مملة للغاية لدرجة أن الفرق تؤجل التدويل حتى يصبح إعادة هيكلة ضخمة.
...
- بدون مفاتيح ترجمة أو ملفات JSON
- بدون دوال `t()` أو مكونات تغليف `<T>`
