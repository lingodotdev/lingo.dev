...
i18n מסורתי הוא פולשני. אתם עוטפים כל מחרוזת בפונקציות `t()`, ממציאים מפתחות תרגום (`home.hero.title.v2`), מתחזקים קבצי JSON מקבילים, ורואים את הקומפוננטות שלכם מתנפחות עם boilerplate של לוקליזציה. זה כל כך מייגע שצוותים דוחים בינאום עד שזה הופך לרפקטור מסיבי.
...
2. **Pull Requests:** [שליחת שינויים](https://github.com/lingodotdev/lingo.dev/pulls)
   - כל PR דורש changeset: `pnpm new` (או `pnpm new:empty` לשינויים שאינם release)
