...
| [**Compiler**](#lingodev-compiler) | לוקליזציה של React בזמן build ללא wrappers של i18n | `withLingo()` plugin               |
...
השדה `provider` הוא אופציונלי (ברירת מחדל ל-Lingo.dev Engine). עבור ספקי LLM מותאמים אישית:
