...
| [**SDK**](#lingodev-sdk)           | डायनामिक सामग्री खातिर रनटाइम अनुवाद                 | `npm install lingo.dev`            |
...
पारंपरिक i18n घुसपैठिया बा। रउआ हर स्ट्रिंग के `t()` फंक्शन में लपेट देनी, अनुवाद कुंजी (`home.hero.title.v2`) के आविष्कार करे के पड़ेला, समानांतर JSON फाइल के रखरखाव करे के पड़ेला, आ आपन कंपोनेंट के लोकलाइजेशन बॉयलरप्लेट से फूलल देखे के पड़ेला। ई एतना थकाऊ बा कि टीम अंतर्राष्ट्रीयकरण के तब तक टाल देवेला जब तक कि ई एगो बहुत बड़ रिफैक्टर ना बन जाय।
...
1. [BCP-47 फॉर्मेट](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Locale) के उपयोग करके [`i18n.json`](./i18n.json) में लोकेल कोड जोड़ीं
