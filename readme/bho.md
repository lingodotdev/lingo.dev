...
| [**Compiler**](#lingodev-compiler) | i18n रैपर के बिना बिल्ड-टाइम React स्थानीयकरण        | `withLingo()` प्लगइन               |
...
पारंपरिक i18n घुसपैठिया बा। रउआ हर स्ट्रिंग के `t()` फंक्शन में लपेट देनी, अनुवाद कुंजी (`home.hero.title.v2`) बनावे के पड़ेला, समानांतर JSON फाइल के रखरखाव करे के पड़ेला, आ आपन कंपोनेंट के लोकलाइजेशन बॉयलरप्लेट से फूलल देखे के पड़ेला। ई एतना उबाऊ बा कि टीम अंतर्राष्ट्रीयकरण के तब तक टाल देवेली जब तक ई एगो बहुत बड़ रिफैक्टर ना बन जाय।
...
2. **पुल रिक्वेस्ट:** [बदलाव सबमिट करीं](https://github.com/lingodotdev/lingo.dev/pulls)
   ...
   - सबमिट करे से पहिले सुनिश्चित करीं कि टेस्ट पास हो जाय
