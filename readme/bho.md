...
> **नोट:** अगर रउआ लिगेसी कंपाइलर (`@lingo.dev/_compiler`) के इस्तेमाल करत बानी, त कृपया `@lingo.dev/compiler` में माइग्रेट करीं। लिगेसी कंपाइलर डेप्रिकेटेड बा आ भविष्य के रिलीज में हटा दिहल जाई।
...
`next build` चलाईं आ स्पैनिश आ फ्रेंच बंडल के पॉप आउट होखत देखीं ✨
...
| टूल         | TL;DR                                                                   | डॉक्स                                   |
| ----------- | ----------------------------------------------------------------------- | --------------------------------------- |
| **कंपाइलर** | बिल्ड-टाइम React लोकलाइजेशन                                             | [/compiler](https://lingo.dev/compiler) |
| **CLI**     | वेब आ मोबाइल ऐप, JSON, YAML, markdown, + अउरी खातिर वन-कमांड लोकलाइजेशन | [/cli](https://lingo.dev/cli)           |
| **CI/CD**   | हर पुश पर ऑटो-कमिट ट्रांसलेशन + जरूरत पड़ले पुल रिक्वेस्ट बनाईं         | [/ci](https://lingo.dev/ci)             |
...
[डॉक्स फॉलो करीं →](https://lingo.dev/cli) ई सेटअप कइसे करे के सीखे खातिर।
