...
**ડેવલપમેન્ટ:** `npm run dev` (pseudotranslator નો ઉપયોગ કરે છે, કોઈ API કૉલ્સ નથી)
...
- `real`: LLMs નો ઉપયોગ કરીને વાસ્તવિક અનુવાદો જનરેટ કરો
...
1. **ઇશ્યૂઝ:** [બગ્સ રિપોર્ટ કરો અથવા ફીચર્સની વિનંતી કરો](https://github.com/lingodotdev/lingo.dev/issues)
2. **પુલ રિક્વેસ્ટ્સ:** [ફેરફારો સબમિટ કરો](https://github.com/lingodotdev/lingo.dev/pulls)
   ...
   - સબમિટ કરતા પહેલા ખાતરી કરો કે ટેસ્ટ્સ પાસ થાય છે
