...
- JSX માં અનુવાદ યોગ્ય ટેક્સ્ટની સ્વચાલિત શોધ
- TypeScript સપોર્ટ
...
- `real`: LLM નો ઉપયોગ કરીને વાસ્તવિક અનુવાદો જનરેટ કરો
- `cache-only`: CI થી પૂર્વ-જનરેટ કરેલા અનુવાદોનો ઉપયોગ કરીને પ્રોડક્શન મોડ (કોઈ API કૉલ્સ નથી)
