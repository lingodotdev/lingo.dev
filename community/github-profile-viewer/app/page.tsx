      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex justify-end mb-6">
          <LocaleSwitcher
            ...
            className="px-4 py-2 bg-white/70 dark:bg-zinc-900/70 backdrop-blur-lg border border-zinc-200 dark:border-zinc-800 rounded-lg text-zinc-900 dark:text-white font-medium focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
