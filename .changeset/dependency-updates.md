...
- `lingo.dev`: removed unused `ink`/`@inkjs/ui`/`ink-spinner`/`ink-progress-bar` (dead deps; avoids ink v7's Node >=22 requirement); `unist-util-visit` 5.0.0 → 5.1.0, `@biomejs/wasm-nodejs` 2.4.6 → 2.5.0.
