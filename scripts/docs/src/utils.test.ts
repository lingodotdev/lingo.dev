...
import { getRepoRoot, getGitHubToken, getGitHubRepo, getGitHubOwner, getGitHubPRNumber } from './utils'
...
describe('utils', () => {
  ...
  describe('getGitHubRepo', () => {
    ...
    it('should throw error when GITHUB_REPOSITORY is not set', () => {
      ...
      expect(() => getGitHubRepo()).toThrow('GITHUB_REPOSITORY environment variable is missing.')
    })
  })
  ...
  describe('getGitHubOwner', () => {
    ...
    it('should throw error when GITHUB_REPOSITORY is not set', () => {
      ...
      expect(() => getGitHubOwner()).toThrow('GITHUB_REPOSITORY environment variable is missing.')
    })
  })
  ...
  describe('getGitHubPRNumber', () => {
    ...
    it('should throw error when no PR number can be determined', () => {
      ...
      expect(() => getGitHubPRNumber()).toThrow('Could not determine pull request number.')
    })
  })
})