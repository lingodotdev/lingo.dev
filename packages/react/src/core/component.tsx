...
/**
 * Core component for rendering localized content with variable substitution.
 * 
 * This component handles the rendering of localized strings with support for
 * variable substitution, element replacement, function calls, and expressions.
 * It is the foundational component used by the Lingo.dev compiler.
 * 
 * @param props - Component props including dictionary, element type, and substitution values.
 * @param ref - React ref to forward to the rendered element.
 * @returns Rendered JSX element with localized content.
 * 
 * @example Render localized text with variable substitution
 * ```tsx
 * import { LingoComponent } from "lingo.dev/react/core";
 * 
 * const dictionary = {
 *   files: {
 *     "welcome.json": {
 ...
 * ```
 * 
 * @example Render localized content with React elements
 * ```tsx
 * import { LingoComponent } from "lingo.dev/react/core";
 * 
 * const dictionary = {
 ...
 *     "message.json": {
 *       entries: {
 *         "linkText": "Visit <element:link>our website</element:link>"
 *       }
 *     }
 *   }
 * };
 ...
 *       $dictionary={dictionary}
 *       $as="div"
 *       $fileKey="message.json"
 *       $entryKey="linkText"
 *       $elements={[({ children }) => <a href="https://example.com">{children}</a>]}
 *     />
 *   );
 * }
 * ```
