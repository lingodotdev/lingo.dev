...
describe("createBasicTranslator", () => {
  ...
  it("should process >25 keys in multiple batches by default (fallback batch size 25)", async () => {
    ...
    // Should be 2 calls, since default fallback is 25 and we have 30 keys
